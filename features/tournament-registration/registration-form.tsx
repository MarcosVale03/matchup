        ...
        return (
            <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
                <div className="bg-white rounded-3xl shadow-sm p-10 max-w-md w-full">
                    ...
                    <h2 className="text-2xl lg:text-3xl font-jersey text-primary mb-2">
                        You&apos;re Registered!
                    </h2>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                        <button
                            ...
                            className="bg-primary text-white px-5 py-2 rounded-md font-jersey text-base
                        ...
                        <button
                            ...
                            className="border-2 border-primary text-primary px-5 py-2 rounded-md font-jersey text-base
            ...
            <div className="p-4 sm:p-6 lg:p-8 flex flex-col lg:flex-row gap-6 max-w-6xl mx-auto w-full">
                ...
                <div className="flex-1 min-w-0">
                    <div className="pb-3 border-b border-zinc-300 mb-4">
                        <h2 className="text-xl lg:text-3xl font-jersey">Select Events</h2>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="relative bg-zinc-800 py-10 sm:py-12 text-center">
                                            ...
                                            <div className="absolute left-3 bottom-3 bg-zinc-600 rounded-lg px-2 py-1 text-sm font-jersey text-white">
                                        ...
                                        <div className="bg-white p-3 sm:p-4">
                                            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
                                                <div>
                                                    ...
                                                    <p className="text-sm text-zinc-500">
                                                        <span className="font-jersey text-base tracking-normal font-normal">Platform: </span>
                                                        {event.gaming_platform_name}
                                                    </p>
                                                </div>
                                                <div className="sm:text-right shrink-0">
                                                    <p className="text-base lg:text-xl font-jersey">Date & Time</p>
                                            ...
                                            <div className="grid grid-cols-2 xs:grid-cols-3 mt-3 border-t-2 border-zinc-200 pt-3 gap-y-3">
                                                <div>
                                                    <p className="text-sm font-jersey tracking-wide">Entry Fee</p>
                                                ...
                                                <div>
                                                    <p className="text-sm font-jersey tracking-wide">Format</p>
                                                    <p className="text-sm font-poppins tracking-tight flex items-center gap-1">
                                                ...
                                                <div>
                                                    <p className="text-sm font-jersey tracking-wide">Game</p>
                                                    <p className="text-sm font-poppins tracking-tight flex items-center gap-1">
                                            ...
                                            <div className="mt-3 pt-3 border-t border-zinc-100 flex items-center justify-between">
                                                ...
                                                />
                                                <span className={`text-sm font-jersey transition-colors duration-150 ${isSelected ? 'text-primary' : 'text-zinc-400'}`}>
                ...
                <div className="lg:w-72 xl:w-80 shrink-0">
                    <div className="bg-white rounded-2xl shadow-sm p-5 sticky top-4">
                        <h3 className="text-xl font-jersey mb-3 pb-2 border-b border-zinc-200">
                        ...
                        <div className="border-t border-zinc-200 pt-3 mb-4">
                            <div className="flex justify-between items-center font-poppins">
                                ...
                                <span className="text-lg font-jersey">
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-2 bg-primary text-white
                                       px-4 py-2.5 rounded-md font-jersey text-lg
                                       hover:bg-secondary transition-colors duration-150
